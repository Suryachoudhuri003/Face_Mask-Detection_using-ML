...
<div align= "center"><img src="https://github.com/Suryachoudhuri003/Face_Mask-Detection_using-ML/blob/master/Logo/Screenshot-2021-02-11-at-16.52.15-495x400.png" width="200" height="200"/>
  <h4>Face Mask Detection System built with OpenCV, Keras/TensorFlow using Deep Learning and Computer Vision concepts in order to detect face masks in static images as well as in real-time video streams.</h4>
</div>

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
![Python](https://img.shields.io/badge/python-v3.6+-blue.svg)
[![contributions welcome](https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat)](https://github.com/Suryachoudhuri003/Face-Mask-Detection_using-ML/issues)
[![LinkedIn](https://img.shields.io/badge/-LinkedIn-black.svg?style=flat-square&logo=linkedin&colorB=555)](https://www.linkedin.com/in/surya-choudhuri-34a147209/)


&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
![Live Demo](https://github.com/Suryachoudhuri003/Face_Mask-Detection_using-ML/blob/master/Readme_images/test.gif)
...
## :file_folder: Dataset
The dataset used can be downloaded here - [Click to Download](https://github.com/Suryachoudhuri003/Face-Mask-Detection_using-ML/tree/master/dataset)
...
* __Bing Search API__ ([See Python script](https://github.com/Suryachoudhuri003/Face-Mask-Detection_using-ML/blob/master/search.py))
* __Kaggle datasets__ 
* __RMFD dataset__ ([See here](https://github.com/X-zhangyang/Real-World-Masked-Face-Dataset))

## :key: Prerequisites

All the dependencies and required libraries are included in the file <code>requirements.txt</code> [See here](https://github.com/Suryachoudhuri003/Face-Mask-Detection_using-ML/blob/master/requirements.txt)

## 🚀&nbsp; Installation
1. Clone the repo
```
$ git clone https://github.com/Suryachoudhuri003/Face_Mask-Detection_using-ML.git
```
...
#### Our model gave 98% accuracy for Face Mask Detection after training via <code>tensorflow-gpu==2.10.0</code>

####          
![](https://github.com/chandrikadeb7/Face-Mask-Detection/blob/master/Readme_images/Screenshot%202020-06-01%20at%209.48.27%20PM.png)

#### We got the following accuracy/loss training curve plot
![](https://github.com/Suryachoudhuri003/Face_Mask-Detection_using-ML/blob/master/plot.png)
...
## :eyes: License
GNU © [Surya Choudhuri](https://github.com/Suryachoudhuri003/Face_Mask-Detection_using-ML/blob/master/LICENSE.md)
